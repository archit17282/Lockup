package com.example.architpanwar.lockup.utility;
...
/**
 * Created by architpanwar on 11/01/18.
 */
...
public class Sharedprefence {
    ...
    public void saveLocked(Context context, List<String> lockedApp) {
        ...
        settings = context.getSharedPreferences(Constants.MyPREFERENCES,
    ...
    public String getPassword(Context context) {
        ...
        passwordPref = context.getSharedPreferences(Constants.MyPREFERENCES, Context.MODE_PRIVATE);
        if (passwordPref.contains(Constants.PASSWORD)) {
            return passwordPref.getString(Constants.PASSWORD, "");
        }
        return "";
    }
